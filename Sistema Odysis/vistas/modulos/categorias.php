    ...
    <div class="modal-content">
      ...
      <form role="form" method="post">
        ...
        <div class="modal-header" style="background:#3c8dbc; color:white">
          ...
          <h4 class="modal-title">Agregar Tipos de Articulos</h4>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary">Guardar Tipos de Articulos</button>
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post">
        ...
        <div class="modal-header" style="background:#3c8dbc; color:white">
          ...
          <h4 class="modal-title">Editar Tipos Articulos</h4>
